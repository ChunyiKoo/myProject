...
// Add the routes to the Express application by importing with the other imports in backend/app.js and connecting the exported router to app.
const routes = require("./routes");
app.use(routes);
// Connect all the routes

//Connect the following error handling middlewares after your route connections in app.js (i.e., after app.use(routes)).
